...
<section class="header-area header-one">
  <div class="header-content-area">
          ...
          <div class="header-wrapper">
            <div class="header-content">
              <h1 class="header-title">
                <?php echo CFS()->get('home-title') ?>
              </h1>
              <p class="text-lg">
                <?php echo CFS()->get('home-description') ?>
              </p>
              <div class="header-btn rounded-buttons">
                <a class="btn primary-btn-outline" href="<?php echo get_category_link(5); ?>">
                  <?php echo CFS()->get('home-btn-text') ?>
                </a>
              </div>
            </div>
            <!-- header content -->
    ...
    <div class="header-shape">
      <?php
      $header_shape = get_theme_mod('header_shape');
      if ($header_shape) {
        echo '<img src="' . esc_url($header_shape) . '" alt="' . get_bloginfo('name') . '">';
      }
      ?>
    </div>
    <!-- header-shape -->
